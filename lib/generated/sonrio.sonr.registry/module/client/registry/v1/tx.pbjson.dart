...
final $typed_data.Uint8List msgCreateWhoIsResponseDescriptor = $convert.base64Decode('ChZNc2dDcmVhdGVXaG9Jc1Jlc3BvbnNlEhAKA2RpZBgBIAEoCVIDZGlkEjIKBndob19pcxgCIAEoCzIbLnNvbnJpby5zb25yLnJlZ2lzdHJ5Lldob0lzUgV3aG9Jcw==');
...
final $typed_data.Uint8List msgUpdateWhoIsDescriptor = $convert.base64Decode('Cg5Nc2dVcGRhdGVXaG9JcxIYCgdjcmVhdG9yGAEgASgJUgdjcmVhdG9yEhAKA2RpZBgCIAEoCVIDZGlkEiEKDGRpZF9kb2N1bWVudBgDIAEoDFILZGlkRG9jdW1lbnQ=');
...
final $typed_data.Uint8List msgUpdateWhoIsResponseDescriptor = $convert.base64Decode('ChZNc2dVcGRhdGVXaG9Jc1Jlc3BvbnNlEhAKA2RpZBgBIAEoCVIDZGlkEjIKBndob19pcxgCIAEoCzIbLnNvbnJpby5zb25yLnJlZ2lzdHJ5Lldob0lzUgV3aG9Jcw==');
...
final $typed_data.Uint8List msgDeactivateWhoIsDescriptor = $convert.base64Decode('ChJNc2dEZWFjdGl2YXRlV2hvSXMSGAoHY3JlYXRvchgBIAEoCVIHY3JlYXRvchIQCgNkaWQYAiABKAlSA2RpZA==');
...
final $typed_data.Uint8List msgBuyAliasDescriptor = $convert.base64Decode('CgtNc2dCdXlBbGlhcxIYCgdjcmVhdG9yGAEgASgJUgdjcmVhdG9yEhAKA2RpZBgCIAEoCVIDZGlkEhIKBG5hbWUYAyABKAlSBG5hbWU=');
...
final $typed_data.Uint8List msgBuyAliasResponseDescriptor = $convert.base64Decode('ChNNc2dCdXlBbGlhc1Jlc3BvbnNlEhAKA2RpZBgBIAEoCVIDZGlkEjIKBndob19pcxgCIAEoCzIbLnNvbnJpby5zb25yLnJlZ2lzdHJ5Lldob0lzUgV3aG9Jcw==');
...
const MsgTransferAlias$json = const {
  ...
  '2': const [
    ...
    const {'1': 'amount', '3': 5, '4': 1, '5': 5, '10': 'amount'},
  ],
};

/// Descriptor for `MsgTransferAlias`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List msgTransferAliasDescriptor = $convert.base64Decode('ChBNc2dUcmFuc2ZlckFsaWFzEhgKB2NyZWF0b3IYASABKAlSB2NyZWF0b3ISEAoDZGlkGAIgASgJUgNkaWQSFAoFYWxpYXMYAyABKAlSBWFsaWFzEhwKCXJlY2lwaWVudBgEIAEoCVIJcmVjaXBpZW50EhYKBmFtb3VudBgFIAEoBVIGYW1vdW50');
...
final $typed_data.Uint8List msgSellAliasDescriptor = $convert.base64Decode('CgxNc2dTZWxsQWxpYXMSGAoHY3JlYXRvchgBIAEoCVIHY3JlYXRvchIQCgNkaWQYAiABKAlSA2RpZBIUCgVhbGlhcxgDIAEoCVIFYWxpYXMSFgoGYW1vdW50GAQgASgFUgZhbW91bnQ=');
