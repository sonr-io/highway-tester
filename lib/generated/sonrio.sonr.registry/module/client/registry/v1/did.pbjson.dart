...
final $typed_data.Uint8List verificationMethodDescriptor = $convert.base64Decode('');
...
const Service$json = const {
  ...
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'type', '3': 2, '4': 1, '5': 9, '10': 'type'},
    const {'1': 'service_endpoint', '3': 3, '4': 1, '5': 9, '10': 'serviceEndpoint'},
  ],
};

/// Descriptor for `Service`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List serviceDescriptor = $convert.base64Decode('CgdTZXJ2aWNlEg4KAmlkGAEgASgJUgJpZBISCgR0eXBlGAIgASgJUgR0eXBlEikKEHNlcnZpY2VfZW5kcG9pbnQYAyABKAlSD3NlcnZpY2VFbmRwb2ludA==');
