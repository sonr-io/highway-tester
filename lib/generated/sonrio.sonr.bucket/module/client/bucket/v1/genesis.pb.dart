...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'sonrio.sonr.bucket'), createEmptyInstance: create)
    ...
    ..pc<$5.WhichIs>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'whichIsList', $pb.PbFieldType.PM, protoName: 'whichIsList', subBuilder: $5.WhichIs.create)
  ...
  factory GenesisState({
    $4.Params? params,
    $core.Iterable<$5.WhichIs>? whichIsList,
  }) {
    ...
    if (whichIsList != null) {
      _result.whichIsList.addAll(whichIsList);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  $core.List<$5.WhichIs> get whichIsList => $_getList(1);
}
